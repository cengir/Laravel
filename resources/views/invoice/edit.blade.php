                                ...
                                <div class="col-md-6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><b>{{ $invoice->customer->name }}</b></td>
                                        </tr>
                                        <tr>
                                            <td>Alamat</td>
                                            <td>:</td>
                                            <td><b>{{ $invoice->customer->address }}</td>
                                        </tr>
                                        <tr>
                                            <td>No Telp</td>
                                            <td>:</td>
                                            <td><b>{{ $invoice->customer->phone }}</td>
                                        </tr>
                                        <tr>
                                            <td>Email</td>
                                            <td>:</td>
                                            <td><b>{{ $invoice->customer->email }}</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    <table>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td><b>Mayashi SpeedShop</td>
                                        </tr>
                                        <tr>
                                            <td>Alamat</td>
                                            <td>:</td>
                                            <td><b>Jl Kampung Kobra Tambun</td>
                                        </tr>
                                        <tr>
                                            <td>No Telp</td>
                                            <td>:</td>
                                        ...
                                        <table class="table table-hover table-bordered-5">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form
                                                            action="{{ route('invoice.delete_product', ['id' => $detail->id]) }}"
                                                            method="post">
                                                            @csrf
