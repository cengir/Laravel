...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['prefix' => 'product'], function () {
        ...
        //jadi nanti ketika route new/new/new/new mau di akses oleh menu lain 
        //maka route yg kita gunakan ada yg ->name('new').
        //simplean mana new/new/new/new atau new ?
    ...
    Route::group(['prefix' => 'customer'], function () {
        ...
        //jadi route di atas akan mengakses  fungsi create di controller CustomerController
        //sekarang kita buat dulu fungsi createnya di CustomerCntrolle
    });
